...
const Footer = () => {
    return (
        <footer class="border-t-2 py-16 ">
            <div class="mx-auto mx-12 text-center mb-16 flex space-x-24 justify-around items-center">
            ...
            <div class=" flex flex-col items-center justify-around">
                ...
                <span class="text-sm text-gray-500 sm:text-center"><a href="https://github.com/RagAndRoll" target="_blank" class="hover:underline">© 2022  RagAndRoll. All Rights Reserved.</a>
                </span>
            </div>
        </footer>
    )
