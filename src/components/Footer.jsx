...
const Footer = () => {
  return (
    <footer className="border-t-2 py-16 ">
      <div className="mx-12 text-center mb-16 flex flex-col lg:flex-row justify-around items-center">
        <a className="self-center my-3 lg:self-start " href="#">
        ...
        <div>
          ...
          <ul>
            <li className="mb-4">
              <a href="#" target="_blank" className="text-gray-600 hover:underline">
                Privacy Policy
              </a>
            </li>
            <li>
