...
const Navbar = () => {
  return (
    <div class="w-screen border-b-2 shadow-md border-gray-100 pb-5">
      <div class=" mx-auto my-5 px-4 sm:px-6 ">
        <div class="flex flex-wrap py-6 justify-evenly md:justify-between gap-y-4">
          <input
            class="hidden md:block leading-none outline-none border-b-2 hover:border-b-3 border-red-800 w-1/4"
            type="text"
            placeholder=" Search.."
          />
          {/* TITLE */}
            ...
            <div class="flex justify-center ">
              <div class="flex justify-center items-center">
                <Link to="MarketPlace_AisModa/">
                  <span class="whitespace-nowrap text-4xl italic font-light text-red-700 hover:text-gray-900">
                    AisModa.
                  </span>
                </Link>
              </div>
          ...
          {/* OTHER */}
          <div class="flex w-full md:w-fit justify-between md:justify-space-around items-center">
            <div class="whitespace-nowra flex justify-center items-center gap-2 ">
            ...
            <NavLink
              ...
              className=" whitespace-nowrap text-base  text-gray-500 hover:text-gray-900 hidden md:block"
            >
              <img
                class="m-1 inline-block h-5 w-5 rounded-full ring-2 ring-white"
          ...
          {/*OTHER TITLE */}
          <a class="w-full block md:hidden" href="#">
            <div class="flex justify-center ">
              <div class="flex justify-center items-center">
                <Link to="MarketPlace_AisModa/">
                  <span class="whitespace-nowrap text-4xl italic font-light text-red-700 hover:text-gray-900">
      ...
      <nav class="flex justify-center my-3">
        <div>
          ...
          <a href="#" class="mx-8 text-base  text-gray-500 hover:text-red-900">
            {" "}
            Docs{" "}
          </a>
          <a href="#" class="mx-8 text-base  text-gray-500 hover:text-red-900">
