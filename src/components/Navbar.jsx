    ...
    return (
        <div class="border-b-2 shadow-md border-gray-100 pb-5">
            ...
            <div class="max-w-7xl mx-auto my-5 px-4 sm:px-6 ">
                <div class="min-w-full flex  py-6 md:justify-between  md:space-x-10">
                    ...
                    <div class="-mr-2 -my-2 md:hidden">
                        <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-900 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                    ...
                    <div class="flex justify-end ">
                        <div class="whitespace-nowrap pt-1  mx-3 flex justify-center space-x-1 ">
            ...
            <nav class="flex justify-center my-3">
                <div>
                    <a href="#" class="mx-8 text-base  text-gray-500 hover:text-red-900"> Pricing </a>
